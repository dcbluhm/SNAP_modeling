...
national_avg <- snap_2model |>
 ...
 ggplot(national_avg, aes(x = year, y = national_avg_rate)) +
  ...
  labs(
    title = "National Average SNAP Participation Rate by Year",
...
snap_2model %>%
  ...
  pivot_longer(cols = c(poverty_pct, renter_pct, unemployment_rate, over_65_pct),
               names_to = "predictor", values_to = "value") %>%
  ggplot(aes(x = value, y = snap_participation_rate)) +
  geom_point(alpha = 0.3) +
  geom_smooth(method = "lm", color = "blue") +
  facet_wrap(~ predictor, scales = "free_x") +
  labs(title = "Predictor Variables vs SNAP Participation Rate",
       x = "Predictor Value", y = "SNAP Participation Rate") +
  theme_minimal()
