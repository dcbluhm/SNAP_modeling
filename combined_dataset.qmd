...
snap_2model <- snap_participation |>
  ...
  filter(snap_participation_rate < 1,
       state_name %in% c("Alabama", "Arkansas", "Delaware", "District of Columbia", "Florida", "Georgia", 
...
# set up folds
snap_folds <- rolling_origin(snap_train, initial = 1343, assess = 1343, cumulative = FALSE)
